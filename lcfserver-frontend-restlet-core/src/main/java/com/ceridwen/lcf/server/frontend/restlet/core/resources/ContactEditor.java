...
public class ContactEditor extends ServerResource {

	ResourceHandler<Contact> handler;
	
	public ContactEditor() {
		handler = new ResourceHandler<>(this, EntityTypes.Type.Contact);
	}
	...
	public Contact Modify(Contact data) {
