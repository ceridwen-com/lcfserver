...
public class RestletExceptionMapper {
	...
	HashMap<Class<? extends Throwable>, ExceptionMap> map = new HashMap<Class<? extends Throwable>, ExceptionMap>() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5391309534049641070L;
		{
	...
	Status GetStatus(Throwable e) {
		...
		return new Status(lcf_exception.getHTTPErrorCode(), lcf_exception);						
	}
}
