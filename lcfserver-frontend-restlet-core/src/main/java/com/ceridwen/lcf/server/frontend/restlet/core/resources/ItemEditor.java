...
public class ItemEditor extends ServerResource {

	ResourceHandler<Item> handler;
	
	public ItemEditor() {
		handler = new ResourceHandler<>(this, EntityTypes.Type.Item);
	}
