...
public class PaymentEditor extends ServerResource {

	ResourceHandler<Payment> handler;
	
	public PaymentEditor() {
		handler = new ResourceHandler<>(this, EntityTypes.Type.Payment);
	}
	...
	public Payment Modify(Payment data) {
