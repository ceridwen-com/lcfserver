...
public class ReservationEditor extends ServerResource {

	ResourceHandler<Reservation> handler;
	
	public ReservationEditor() {
		handler = new ResourceHandler<>(this, EntityTypes.Type.Reservation);
	}
	...
	public Reservation Modify(Reservation data) {
