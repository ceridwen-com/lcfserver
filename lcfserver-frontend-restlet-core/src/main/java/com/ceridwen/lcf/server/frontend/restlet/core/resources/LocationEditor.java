...
public class LocationEditor extends ServerResource {

	ResourceHandler<Location> handler;
	
	public LocationEditor() {
		handler = new ResourceHandler<>(this, EntityTypes.Type.Location);
	}
	...
	public Location Modify(Location data) {
