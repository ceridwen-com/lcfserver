...
public class ReservationResource {
	ResourceHandler<Reservation> handler;
	
	public ReservationResource() {
		handler = new ResourceHandler<>(EntityTypes.Type.Reservation);
	}

	@GET
	@Path("/lcf/1.0/reservations")
	...
	@GET
	@Path("/lcf/1.0/{parent}/{identifier}/reservations")
	...
	@POST
	@Path("/lcf/1.0/{parent}/{identifier}/reservations")	
	public Reservation Create(@PathParam("parent") String parent, @PathParam("identifier") String identifier, Reservation data) {
		return handler.Create(parent, identifier, data);
	}

	@GET
	@Path("/lcf/1.0/reservations/{identifier}")
	public Reservation Retrieve(@PathParam("identifier") String identifier) {
		return handler.Retrieve(identifier);
	}

	@PUT
	@Path("/lcf/1.0/reservations/{identifier}")
	public Reservation Modify(@PathParam("identifier") String identifier, Reservation data) {
