...
public class LocationModifier extends Referencer<Location> {

	public LocationModifier(Location entity, ReferenceEditor modifier) {
		super(entity, modifier);
	}

	@Override
	protected Location updateReferences(Location entity, final boolean addUrlPrefix) {
