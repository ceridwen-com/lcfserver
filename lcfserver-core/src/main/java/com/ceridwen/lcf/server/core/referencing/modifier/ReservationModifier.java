...
public class ReservationModifier extends Referencer<Reservation> {

	public ReservationModifier(Reservation entity, ReferenceEditor modifier) {
		super(entity, modifier);
	}

	@Override
	protected Reservation updateReferences(Reservation entity, final boolean addUrlPrefix) {
...
//		entity.getPickupInstitutionRef()
//		entity.getPickupLocationRef()
