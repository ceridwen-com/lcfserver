...
public class LcfCheckOutResponseModifier extends Referencer<LcfCheckOutResponse> {

	public LcfCheckOutResponseModifier(LcfCheckOutResponse entity, ReferenceEditor modifier) {
		super(entity, modifier);
	}

	@Override
	protected LcfCheckOutResponse updateReferences(
			LcfCheckOutResponse entityType, boolean addUrlPrefix) {
