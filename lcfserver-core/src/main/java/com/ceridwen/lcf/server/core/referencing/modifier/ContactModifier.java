...
public class ContactModifier extends Referencer<Contact> {

	public ContactModifier(Contact entity, ReferenceEditor modifier) {
		super(entity, modifier);
	}

	@Override
	protected Contact updateReferences(Contact entity, final boolean addUrlPrefix) {
