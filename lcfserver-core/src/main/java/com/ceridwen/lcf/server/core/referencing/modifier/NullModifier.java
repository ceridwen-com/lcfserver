...
public class NullModifier extends Referencer<Object>{

	public NullModifier(Object entity, ReferenceEditor modifier) {
		super(entity, modifier);
	}


	@Override
	protected Object updateReferences(Object entity, boolean addUrlPrefix) {
		return entity;
	}
}
