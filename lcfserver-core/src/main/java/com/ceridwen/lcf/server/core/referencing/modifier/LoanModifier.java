...
public class LoanModifier extends Referencer<Loan> {

	public LoanModifier(Loan entity, ReferenceEditor modifier) {
		super(entity, modifier);
	}

	@Override
	protected Loan updateReferences(Loan entity, final boolean addUrlPrefix) {
