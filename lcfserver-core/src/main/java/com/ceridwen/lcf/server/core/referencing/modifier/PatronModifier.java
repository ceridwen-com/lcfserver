...
public class PatronModifier extends Referencer<Patron> {
	public PatronModifier(Patron entity, ReferenceEditor modifier) {
		super(entity, modifier);
	}

	@Override
	public Patron dereference() {
		return super.dereference();
	}

	@Override
	protected org.bic.ns.lcf.v1_0.Patron updateReferences(Patron entity, final boolean addUrlPrefix) {
		...
		entity.getContactRef().replaceAll(getUpdateOperator(EntityTypes.Type.Contact, addUrlPrefix));
		entity.getLoanRef().replaceAll(getUpdateOperator(EntityTypes.Type.Loan, addUrlPrefix));
