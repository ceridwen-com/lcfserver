...
public class LcfCheckInResponseModifier extends Referencer<LcfCheckInResponse> {

	public LcfCheckInResponseModifier(LcfCheckInResponse entity, ReferenceEditor modifier) {
		super(entity, modifier);
	}

	@Override
	protected LcfCheckInResponse updateReferences(LcfCheckInResponse entityType,
